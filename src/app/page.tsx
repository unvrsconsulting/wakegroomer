...
const FAQS = [
  ...
  },
  {
    ...
    a: "Coverage is still growing across NC. Try a nearby city in the search filters, or let a local groomer know they can list for free.",
  },
  {
...
export default async function Home() {
  ...
  return (
    <div>
      ...
      <Hero cities={[...cityCounts.map((c) => c.city)].sort()} />
      ...
      <section className="border-b border-[var(--color-border)] bg-[var(--color-surface)] py-6">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-2 px-4 sm:px-6 lg:px-8">
          ...
          {cityCounts.slice(0, 8).map(({ city: c }) => (
            <Link
              key={c}
      ...
      <section className="border-t border-[var(--color-border)] py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between gap-4">
            <div>
              <h2 className="text-3xl font-bold text-foreground">Recently Added Groomers</h2>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
            {serviceCounts.map(({ service, count }) => {
              const photo = SERVICE_PHOTOS[service];
              return (
                <div
                  key={service}
                  className="card-shadow card-shadow-hover group relative overflow-hidden rounded-2xl border border-[var(--color-border)] bg-white text-center transition hover:border-brand"
                >
                  <Link
      ...
      <section className="border-y border-[var(--color-border)] py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold text-foreground">Coverage Across NC</h2>
            <p className="mt-2 text-foreground/70">
            ...
            {[
              {
                ...
                body: "Filter by city, zip code, or service to see groomers who actually serve your street.",
              },
              {
                step: "2",
